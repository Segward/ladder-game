...
public class MainFrame {
  ...
  public void init() {
    ...
    buttonPane.getChildren().addAll(startLadderGame, startPartyGame, configureGame, exitGame);
    root.setCenter(buttonPane);

    MainFrameController mainFrameController = new MainFrameController(root);
    mainFrameController.init(startLadderGame, startPartyGame, configureGame, exitGame);
  }
}
