...
public class Scene2 {
  ...
  public Scene2(Runnable onSwitchToScene1) {
    content = new Pane();
    ...
    Button button = Graphics.createButton("Go to Scene1", position, size, content);
    Graphics.setRelativePosition(content, button, new Vector2(0.5, 0.5));

    button.setOnAction(e -> onSwitchToScene1.run());
