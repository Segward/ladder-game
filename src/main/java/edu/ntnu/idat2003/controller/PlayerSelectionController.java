...
import edu.ntnu.idat2003.view.FigureSelection;
import edu.ntnu.idat2003.view.GameSelection;
...
public class PlayerSelectionController {
  ...
  public PlayerSelectionController(
      Pane root, Button add, Button resume, HBox hBox, Button loadFromFile, Button saveToFile) {
    this.root = root;
    this.add = add;
    this.resume = resume;
    this.hBox = hBox;
