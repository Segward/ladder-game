...
/** Class representing Main menu screen functonality. Deffines funtionality to buttons. */
public class MainFrameController {

  private final BorderPane root;

  /**
   * Constructor for the MainFrameController. Takes BoarderPane as parameter.
   *
  ...
  /**
   * Initiates the functonality of buttons. Deffines which method each button initiates
   *
  ...
  /**
   * Method that initialises LadderGame. Creates a new LadderGame object, then initialises
   * ladderGame init() method.
   */
  ...
  /**
   * Method that initialises quiz game. Creates a new BoardSelection object, then initialises
   * boardSelection init() method.
   */
  ...
  /**
   * Method that initialises configuration screen. Creates a new configuration object, then
   * initialises configuration init() method.
   */
  ...
  /**
   * Method that initialises TicTacToe game. Creates a new tictactoe object, then initialises
   * tictactoe init() method.
   */
  ...
  /** Method for exiting application. setts system status to 0. */
