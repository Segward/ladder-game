...
public class Player {
  ...
  /**
   *  Setter for extra dice value.
   *  Takes a boolean value as a parameter and
   *  sets that as the new value of extraDice.
   *  Represents if the player has an extra die to be rolled. 
   * 
   * @param extraDice new extraDice boolean value
   */
