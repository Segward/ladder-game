...
public class FigureFactory {
  /**
   * Method that creates a set of Figures. Hard codes 5 unique Figure objects and adds them to an
   * HasSet, before utilizing a FigureWritter method to save them as csv.
   */
  public static void makeFigures() {
    ...
    try {
      ...
      System.out.println("Error writing figure data to file: " + e.getMessage());
    }
  }
}
